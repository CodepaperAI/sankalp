  ...
  return (
    ...
    >
      ...
      <div className="hidden lg:flex items-center gap-6">
        ...
        <Link
          href="/book"
          className="text-[0.7rem] tracking-[0.15em] uppercase font-semibold px-5 py-3 bg-[var(--color-accent)] text-[var(--color-text-inverse)] hover:scale-[1.03] hover:shadow-[0_8px_32px_rgba(45,90,61,0.15)] transition-all duration-300"
        >
          Book Consultation
        </Link>
      </div>
