      ...
      <div className="grid grid-cols-1 lg:grid-cols-[0.6fr_1fr] gap-12 lg:gap-24 items-center">
        <ScrollReveal direction="left">
          <div className="aspect-[3/4] relative overflow-hidden">
            <Image src={images.community} alt="Community gathering" fill className="object-cover" sizes="(max-width: 1024px) 100vw, 35vw" />
          </div>
        </ScrollReveal>

        <ScrollReveal delay={0.15}>
          <p className="text-[0.7rem] tracking-[0.25em] uppercase text-[var(--color-accent)] font-medium mb-4">Refer a Friend</p>
