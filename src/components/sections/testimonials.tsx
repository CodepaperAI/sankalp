...
export function Testimonials() {
  return (
    <section className="py-[var(--section-gap)] px-6 lg:px-16 xl:px-24 relative">
      {/* Ambient glow */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-[radial-gradient(circle,rgba(201,169,110,0.04)_0%,transparent_70%)] blur-[80px] pointer-events-none" />
